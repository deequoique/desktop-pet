...
- `../07-17-multi-device-presence-and-personal-audio/design.md`
- `../07-17-pet-scaling-and-diagnostics/design.md`
...
- 控制面板设备/音频区域与桌宠设置区域使用不同状态来源：前者来自 room/server，后者来自 Electron main bridge；独立浏览器隐藏 Electron-only 设置。
...
3. 最后运行全套 server 测试、web/pet build，并手工检查控制面板两组新增 UI 在 Electron 与浏览器中的降级行为。
